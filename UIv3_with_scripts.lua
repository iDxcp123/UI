...
Main.Size = UDim2.new(0.5, 0, 0.8, 0)
...
Dragify(Main)
    ...
    Drag.Size = UDim2.new(0, 410, 0, 22)
    ...
    Main.Position = UDim2.new(-0.001, 0, 0.022766019, 0)
    Main.Size = UDim2.new(0, 410, 0, SizeY)

    Frame.Parent = Main
    Frame.BackgroundColor3 = Color3.new(0.0862245, 0.0862245, 0.0862245)
    Frame.BorderColor3 = Color3.new(0, 0, 0)
    Frame.Position = UDim2.new(0.0137524558, 0, 0.0376303018, 0)
    Frame.Size = UDim2.new(0, 400, 0, Main.Size.Y.Offset - 30)
    ...
    Heading.Position = UDim2.new(0.022700012, 0, 0, 0)
    Heading.Size = UDim2.new(0, 395, 0, 22)
    ...
    Title.Size = UDim2.new(0, #Name * 6.833333333333333, 0, 19)
    ...
    Background.BackgroundColor3 = Color3.new(0.14976, 0.14976, 0.14976)
    Background.BorderColor3 = Color3.new(0, 0, 0)
    Background.Position = UDim2.new(0.0155808367, 0, 0.0427783697, 0)
    Background.Size = UDim2.new(0, 305, 0, Frame.Size.Y.Offset - 27)
    ...
    Content.Position = UDim2.new(0.0124219605, 0, 0.0099593997, 0)
    Content.Size = UDim2.new(0, 376, 0, Background.Size.Y.Offset - 9)
    ...
    Tabs.Position = UDim2.new(0.0226048928, 0, 0, 0)
    Tabs.Size = UDim2.new(0, 300, 0, 19)
    ...
    function WindowLibrary:Label(Name, Color)
        ...
        Differ.Size = UDim2.new(0, 6, 0, 19)
        ...
        Label.Size = UDim2.new(0, #Name * 6.833333333333333, 0, 19)
    ...
    function WindowLibrary:Tab(Name)
        ...
        function SectionLibrary:Section(Name)
            ...
            Section.BackgroundColor3 = Color3.new(0.0862245, 0.0862245, 0.0862245)
            Section.BorderColor3 = Color3.new(0, 0, 0)
            Section.Position = UDim2.new(0.0120000001, 0, 0.00899999961, 0)
            Section.Size = UDim2.new(0, 195, 0, 247)
            Section.ZIndex = 0
            Section.Visible = false
            ...
            SectionContents.Position = UDim2.new(0.0228463159, 0, 0.0322874375, 0)
            ...
            function Functions:Button(Name, Func)
                ...
                Button.Size = UDim2.new(0, 219, 0, 18)
            ...
            function Functions:Toggle(Name, Func)
                ...
                TextLabel.Position = UDim2.new(1.67999995, 0, -0.0140099997, 0)
            ...
            function Functions:Color(Name, Default, Func)
                ...
                local Main = Instance.new("Frame")
Main.Size = UDim2.new(0.5, 0, 0.15, 0)
Main.Position = UDim2.new(0.1, 0, 0.1, 0)
...
Dragify(Main)
                ...
                Color.Position = UDim2.new(1.67999995, 0, -0.0140099997, 0)
                Color.Size = UDim2.new(0, 199, 0, 9)
                Color.ZIndex = 2
                ...
                Main.Position = UDim2.new(0.562814057, 0, 1.61530458, 0)
                Main.Size = UDim2.new(0, 91, 0, 0)
                Main.Visible = false
                ...
                Gradient.BorderColor3 = Color3.new(0.622451, 0.622451, 0.622451)
                Gradient.BorderSizePixel = 0
                Gradient.ClipsDescendants = true
                Gradient.Position = UDim2.new(0.5, 0, 0.270099994, 0)
                Gradient.Size = UDim2.new(0.640099976, 0, 0.640099976, 0)
                ...
                R.PlaceholderColor3 = Color3.new(0.763766, 0.763766, 0.763766)
                R.PlaceholderText = "R"
                R.Text = ""
                ...
                G.PlaceholderColor3 = Color3.new(0.763766, 0.763766, 0.763766)
                G.PlaceholderText = "G"
                G.Text = ""
                ...
                B.PlaceholderColor3 = Color3.new(0.763766, 0.763766, 0.763766)
                B.PlaceholderText = "B"
                B.Text = ""
                ...
                TextLabel.BackgroundColor3 = Color3.new(1, 1, 1)
                TextLabel.BackgroundTransparency = 1
                TextLabel.Position = UDim2.new(1.83304277, 0, -0.0150005631, 0)
                ...
                TextButton.MouseButton1Click:Connect(function()
                    if Main.Visible then
                        tweenProp(Main, {Size = UDim2.new(0, 91, 0, 0)})
                        wait(0.4)
                        Main.Visible = false
                    else
                        Main.Visible = true
                        tweenProp(Main, {Size = UDim2.new(0, 91, 0, 144)})
                    end
                end)
            ...
            function Functions:Dropdown(...)
                ...
                Frame.Size = UDim2.new(0, 219, 0, 0)
                Frame.Visible = false
                Frame.ZIndex = 2
                ...
                local function tweenDropdown(Size, Time)
                    tweenProp(Frame, {Size = UDim2.new(0, 219, 0, (#FuncData-1)*Size)})
                    for _, TextButton in next, Frame:GetChildren() do
                        if TextButton:IsA("TextButton") and TextButton ~= Button then
                            tweenProp(TextButton, {Size = UDim2.new(0, 219, 0, Size)})
                        end
                    end
                    wait(Time)
                ...
                function createfunc(Name, Function)
                    ...
                    Button.Size = UDim2.new(0, 219, 0, 0)
                    Button.AutoButtonColor = false
                    Button.Font = Enum.Font.Code
                    Button.Text = " "..Name
                    Button.TextColor3 = Color3.new(1, 1, 1)
            ...
            function Functions:Keybind(Name, Func)
                ...
                Button.BorderColor3 = Color3.new(0, 0, 0)
                Button.Position = UDim2.new(1.35306304, 0, -0.298530178, 0)
            ...
            function Functions:Slider(Name, Max, Min, Func)
                ...
                Slide.Position = UDim2.new(0, 0, 0.532041025, 0)
                Slide.Size = UDim2.new(0, 219, 0, 18)
                ...
                Num.Position = UDim2.new(0, 92, 0, 0)
            ...
            function Functions:ToggleSlider(Name, Max, Min, Func)
                ...
                Toggle.BackgroundColor3 = Color3.new(0.176471, 0.176471, 0.176471)
                Toggle.BorderColor3 = Color3.new(0, 0, 0)
                Toggle.Position = UDim2.new(1.1768539, 0, -0.092500004, 0)
                Toggle.Size = UDim2.new(0, 13, 0, 13)
                Toggle.AutoButtonColor = false
                Toggle.Font = Enum.Font.Code
                Toggle.Text = ""
            ...
            function Functions:Textbox(Name, Func)
                ...
                TextBox.PlaceholderColor3 = Color3.new(0.763766, 0.763766, 0.763766)
...
local function canSeeTarget(LocalPlayer, Target)
    if not LocalPlayer.Character or not Target.Character then
        return false
    end

    local rayOrigin = LocalPlayer.Character.HumanoidRootPart.Position
    local rayDirection = Target.Character.HumanoidRootPart.Position - rayOrigin
...
local function updateHighlights()
    for _, player in pairs(game.Players:GetPlayers()) do
        if player ~= LocalPlayer then
            ...
            if canSeeTarget(LocalPlayer, player) and onScreen and screenPosition.Z > 0 then
...
aimbotButton.Parent = game.Players.LocalPlayer.PlayerGui.ScreenGui
...
espButton.Parent = game.Players.LocalPlayer.PlayerGui.ScreenGui
